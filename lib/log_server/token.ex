defmodule LogServer.Token do
  ...
  def fake_authenticated(token, user_id) do
    IO.inspect [token, user_id], label: "token, user_d"
    token == "1f26cbfff22e414099a33666d9f3e699" && user_id == 1
  end
